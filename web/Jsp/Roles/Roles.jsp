            ...
            <html:form action="/Roles" method="post">
                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <td colspan="3"><a class="boton" href="javascript:nuevo();">Nuevo</a> <a class="boton" href="javascript:guardar();">Guardar</a> <% if (request.getAttribute("getIdRoles") != "") {%> <a class="boton" href="javascript:eliminar();">Eliminar</a> <% }%> <a class="boton" href="javascript:atras();">Volver</a></td>
                        </tr>
                        <%
