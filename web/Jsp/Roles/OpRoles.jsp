            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td><a class="boton" href="javascript:nuevo()">Nuevo Rol</a></td>
                    </tr>
                </table>
            </fieldset>
            <fieldset>
                ...
                <table>
                    ...
                    <%int color = 1;%>
                    <c:forEach items="${GR_ROLES}" var="cat">
                        <%  if (color == 1) {%>
                        <tr>
                            <td width="40" align="center" height="25" bgcolor="#D8D8D8"><c:out value="${cat.idRoles}"/></td>
                            <td width="130" align="center"  height="25" bgcolor="#D8D8D8"><c:out value="${cat.nombre}"/></td>
                            <td width="60" align="center" height="25" bgcolor="#D8D8D8"><a href="javascript:modifica(${cat.idRoles})">Modificar</a></td>
                        </tr>
                        <% color = 0;%>
                        <% } else {%>
                        <tr>
                            <td width="40" align="center" height="25"><c:out value="${cat.idRoles}"/></td>
                            <td width="130" align="center"  height="25"><c:out value="${cat.nombre}"/></td>
                            <td width="60" align="center" height="25"><a href="javascript:modifica(${cat.idRoles})">Modificar</a></td>
                        </tr>
                        <% color = 1;%>
                        <%}%>
                    </c:forEach>
