...
CREATE TABLE `entidad` (
  ...
  `idPais` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL,
  `idmunicipio` varchar(3) COLLATE latin1_spanish_ci DEFAULT NULL,
  ...
  `idDepartamento` varchar(2) COLLATE latin1_spanish_ci DEFAULT NULL,
...
INSERT INTO `plantilladispositivo` VALUES (3,'prueba3','prueba3',1),(4,'prueba4','prueba4',1),(5,'Prueba','p',1);
...
INSERT INTO `caracteristicaplantilla` VALUES (13,3,'g',0,0);
...
INSERT INTO `plantilladispositivohija` VALUES (3,2),(4,3);
...
INSERT INTO `usuario` VALUES (7,'glinero','�C5M��ND�����֒',1,1065571485,6);
...
-- Dump completed on 2012-07-12 18:20:38
