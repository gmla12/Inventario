            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td>Tipo de Documento<html:select property="bIdTipoDocumento"  size="1" style="width:140px;" value='<%= String.valueOf(session.getAttribute("getbIdTipoDocumento"))%>'>
                        ...
                        <td><a class="boton" href="javascript:nuevo()">Nuevo Entidad</a></td>
                    </tr>
                </table>
            </fieldset>
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <th bgcolor='#BDBDBD' height="25" width="130">Tipo Documento</th>
                        <th bgcolor='#BDBDBD' height="25" width="130">Identificacion</th>
                        <th bgcolor='#BDBDBD' height="25">Editar</th>
                    </tr>
                    <%int color = 1;%>
                    <c:forEach items="${GR_ENTIDAD}" var="cat">
                        <%  if (color == 1) {%>
                        <tr>
                            <td width="40" align="center" height="25" bgcolor="#D8D8D8"><c:out value="${cat.idEntidad}"/></td>
                            <td width="130" align="center"  height="25" bgcolor="#D8D8D8"><c:out value="${cat.nombre}"/></td>
                            <td width="130" align="center"  height="25" bgcolor="#D8D8D8"><c:out value="${cat.nombreTipoDoc}"/></td>
                            <td width="130" align="center"  height="25" bgcolor="#D8D8D8"><c:out value="${cat.identificacion}"/></td>
                            <td width="60" align="center" height="25" bgcolor="#D8D8D8"><a href="javascript:modifica(${cat.idEntidad})">Modificar</a></td>
                        </tr>
                        <% color = 0;%>
                        <% } else {%>
                        <tr>
                            <td width="40" align="center" height="25"><c:out value="${cat.idEntidad}"/></td>
                            <td width="130" align="center"  height="25"><c:out value="${cat.nombre}"/></td>
                            <td width="130" align="center"  height="25"><c:out value="${cat.nombreTipoDoc}"/></td>
                            <td width="130" align="center"  height="25"><c:out value="${cat.identificacion}"/></td>
                            <td width="60" align="center" height="25"><a href="javascript:modifica(${cat.idEntidad})">Modificar</a></td>
                        </tr>
                        <% color = 1;%>
                        <%}%>
                    </c:forEach>
