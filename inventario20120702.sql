...
CREATE TABLE `entidad` (
  ...
  `primerNombre` varchar(40) CHARACTER SET latin1 NOT NULL,
  `segundoNombre` varchar(40) CHARACTER SET latin1 NOT NULL,
  `primerApellido` varchar(40) COLLATE latin1_spanish_ci NOT NULL,
  `segundoApellido` varchar(40) CHARACTER SET latin1 NOT NULL,
  `idTipoDocumento` int(11) NOT NULL,
  `identificacion` bigint(20) NOT NULL,
  `razonSocial` varchar(50) CHARACTER SET latin1 NOT NULL,
  `idPais` varchar(3) COLLATE latin1_spanish_ci NOT NULL,
  `idmunicipio` varchar(3) COLLATE latin1_spanish_ci NOT NULL,
  ...
  `idTipoEntidad` int(10) unsigned NOT NULL,
  `idDepartamento` varchar(2) COLLATE latin1_spanish_ci NOT NULL,
...
INSERT INTO `entidad` VALUES (1,'Gilberth','Miguel','Linero','Ariza',6,1065571485,'','090','001','Mz L Casa 22 Los Corales','3135448426','gilberth12@hotmail.com',1,'13');
...
INSERT INTO `tipoentidad` VALUES (1,'Empleado'),(2,'Cliente'),(3,'Proveedor');
...
INSERT INTO `tipodocumentoaut` VALUES (3,'idEntidad',1,1),(3,'identificacion',1,1),(3,'idTipoDocumento',1,1),(3,'primerApellido',1,1),(3,'primerNombre',1,1),(3,'razonSocial',1,1),(3,'segundoApellido',1,1),(3,'segundoNombre',1,1),(6,'direccion',1,1),(6,'email',1,1),(6,'idDepartamento',1,1),(6,'idEntidad',1,1),(6,'identificacion',1,1),(6,'idmunicipio',1,1),(6,'idPais',1,1),(6,'idTipoDocumento',1,1),(6,'idTipoEntidad',1,1),(6,'primerApellido',1,1),(6,'primerNombre',1,1),(6,'razonSocial',0,0),(6,'segundoApellido',1,0),(6,'segundoNombre',1,0),(6,'telefono',1,1);
...
INSERT INTO `departamentos` VALUES ('05','090','ANTIOQUIA'),('08','090','ATLANTICO'),('11','090','BOGOTA'),('13','090','BOLIVAR'),('15','090','BOYACA'),('17','090','CALDAS'),('18','090','CAQUETA'),('19','090','CAUCA'),('20','090','CESAR'),('23','090','CORDOBA'),('25','090','CUNDINAMARCA'),('27','090','CHOCO'),('41','090','HUILA'),('44','090','GUAJIRA'),('47','090','MAGDALENA'),('50','090','META'),('52','090','NARIÑO'),('54','090','NORTE DE SANTANDER'),('63','090','QUINDIO'),('66','090','RISARALDA'),('68','090','SANTANDER'),('70','090','SUCRE'),('73','090','TOLIMA'),('76','090','VALLE DEL CAUCA'),('81','090','ARAUCA'),('85','090','CASANARE'),('86','090','PUTUMAYO'),('88','090','SAN ANDRES'),('91','090','AMAZONAS'),('94','090','GUAINIA'),('95','090','GUAVIARE'),('97','090','VAUPES'),('99','090','VICHADA');
...
-- Dump completed on 2012-07-02 23:23:39
